...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="feynman-kac"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 05"}
      title={"Feynman–Kac & PDE link"}
      lede={"From conditional expectations to Black–Scholes PDE — the bridge interviewers love."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Feynman–Kac & PDE link"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"From conditional expectations to Black–Scholes PDE — the bridge interviewers love. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// feynman kac — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Feynman–Kac & PDE link"}</strong> Pick one concrete sub-problem
