...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="properties-brownian"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 02"}
      title={"Properties of Brownian motion"}
      lede={"Independent increments, nowhere differentiable, reflection principle sketch."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Properties of Brownian motion"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Independent increments, nowhere differentiable, reflection principle sketch. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// properties brownian — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Properties of Brownian motion"}</strong> Pick one concrete sub-problem
