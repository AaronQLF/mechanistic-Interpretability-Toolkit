...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="ito-integral-lemma"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 03"}
      title={"Itô integral & Itô's lemma"}
      lede={"Why dt terms matter and the chain rule of stochastic calculus."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Itô integral & Itô's lemma"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Why dt terms matter and the chain rule of stochastic calculus. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// ito integral lemma — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Itô integral & Itô's lemma"}</strong> Pick one concrete sub-problem
