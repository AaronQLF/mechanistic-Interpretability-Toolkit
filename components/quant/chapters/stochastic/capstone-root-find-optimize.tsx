...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="capstone-root-find-optimize"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 10"}
      title={"Capstone: root-finding & optimization"}
      lede={"Newton, Brent, bisection; golden section vs gradient descent on toy surfaces."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Capstone: root-finding & optimization"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Newton, Brent, bisection; golden section vs gradient descent on toy surfaces. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// capstone root find optimize — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Capstone: root-finding & optimization"}</strong> Pick one concrete sub-problem
