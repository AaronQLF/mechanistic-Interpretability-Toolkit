...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="sdes-gbm"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 04"}
      title={"SDEs & geometric Brownian motion"}
      lede={"Lognormal stock model, solution of GBM, and discretization Euler–Maruyama."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"SDEs & geometric Brownian motion"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Lognormal stock model, solution of GBM, and discretization Euler–Maruyama. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// sdes gbm — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"SDEs & geometric Brownian motion"}</strong> Pick one concrete sub-problem
