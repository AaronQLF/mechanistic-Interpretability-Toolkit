...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="numerical-linear-algebra"
      chapters={stochasticChapters}
      eyebrow={"Stochastic Calculus & Numerics · 09"}
      title={"Numerical linear algebra"}
      lede={"LU, Cholesky, QR — conditioning and why not to invert matrices explicitly."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Numerical linear algebra"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"LU, Cholesky, QR — conditioning and why not to invert matrices explicitly. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// numerical linear algebra — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Numerical linear algebra"}</strong> Pick one concrete sub-problem
