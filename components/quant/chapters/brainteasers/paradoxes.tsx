...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="paradoxes"
      chapters={brainteasersChapters}
      eyebrow={"Brainteasers & Games · 05"}
      title={"Probability paradoxes"}
      lede={"Monty Hall, Simpson's paradox, non-transitive dice — explain, don't memorize."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Probability paradoxes"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Monty Hall, Simpson's paradox, non-transitive dice — explain, don't memorize. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// paradoxes — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Probability paradoxes"}</strong> Pick one concrete sub-problem
