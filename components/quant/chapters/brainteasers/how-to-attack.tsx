...
import { brainteasersChapters } from "@/lib/quant";

export default function QuantChapter() {
  return (
    <ChapterShell
      moduleSlug={`quant/brainteasers`}
      chapterSlug="how-to-attack"
      chapters={brainteasersChapters}
      eyebrow={"Brainteasers & Games · 01"}
      title={"How to attack any brainteaser"}
      lede={"Clarify, brute force small n, look for symmetry, check edge cases — a repeatable script."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"How to attack any brainteaser"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Clarify, brute force small n, look for symmetry, check edge cases — a repeatable script. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// how to attack — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"How to attack any brainteaser"}</strong> Pick one concrete sub-problem
