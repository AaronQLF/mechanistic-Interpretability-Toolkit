...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="market-making-betting"
      chapters={brainteasersChapters}
      eyebrow={"Brainteasers & Games · 07"}
      title={"Market-making & betting games"}
      lede={"Fair prices, inventory risk, Kelly sketch — the desk flavor of brainteasers."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Market-making & betting games"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Fair prices, inventory risk, Kelly sketch — the desk flavor of brainteasers. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// market making betting — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Market-making & betting games"}</strong> Pick one concrete sub-problem
