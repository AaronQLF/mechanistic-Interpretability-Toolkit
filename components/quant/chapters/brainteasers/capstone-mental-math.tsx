...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="capstone-mental-math"
      chapters={brainteasersChapters}
      eyebrow={"Brainteasers & Games · 09"}
      title={"Capstone: mental math drills"}
      lede={"Compounding, fractions, and approximation under a stopwatch."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Capstone: mental math drills"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Compounding, fractions, and approximation under a stopwatch. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// capstone mental math — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Capstone: mental math drills"}</strong> Pick one concrete sub-problem
