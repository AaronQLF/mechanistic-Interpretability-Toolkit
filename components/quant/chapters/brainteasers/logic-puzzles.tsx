...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="logic-puzzles"
      chapters={brainteasersChapters}
      eyebrow={"Brainteasers & Games · 02"}
      title={"Logic puzzles"}
      lede={"Knights and knaves, truth tables, and constraint propagation."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Logic puzzles"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Knights and knaves, truth tables, and constraint propagation. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// logic puzzles — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Logic puzzles"}</strong> Pick one concrete sub-problem
