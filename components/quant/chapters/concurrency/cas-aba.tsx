...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Concurrency & Lock-Free · 04"}
      title={"Compare-and-swap & the ABA problem"}
      lede={"Lock-free stacks, hazard pointers, and tagged pointers."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Compare-and-swap & the ABA problem"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Lock-free stacks, hazard pointers, and tagged pointers. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// cas aba — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Compare-and-swap & the ABA problem"}</strong> Pick one concrete sub-problem
