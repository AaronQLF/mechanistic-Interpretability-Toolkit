...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="data-oriented-design"
      chapters={systemsChapters}
      eyebrow={"Low-Latency Systems · 05"}
      title={"Data-oriented design"}
      lede={"SoA vs AoS, hot/cold splitting, and ECS-style thinking for tick processing."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Data-oriented design"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"SoA vs AoS, hot/cold splitting, and ECS-style thinking for tick processing. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// data oriented design — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Data-oriented design"}</strong> Pick one concrete sub-problem
