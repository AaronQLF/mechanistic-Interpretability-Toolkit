...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="branch-prediction"
      chapters={systemsChapters}
      eyebrow={"Low-Latency Systems · 03"}
      title={"Branch prediction"}
      lede={"Mispredict costs, branchless tricks, and when to sort to help the predictor."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Branch prediction"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Mispredict costs, branchless tricks, and when to sort to help the predictor. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// branch prediction — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Branch prediction"}</strong> Pick one concrete sub-problem
