...
import { interviewChapters } from "@/lib/quant";

export default function QuantChapter() {
  return (
    <ChapterShell
      moduleSlug={`quant/interview`}
      chapterSlug="behavioral-why-firm"
      chapters={interviewChapters}
      eyebrow={"Interview Strategy & Mocks · 04"}
      title={"Behavioral and why-this-firm questions"}
      lede={"STAR without sounding robotic; research the desk before you walk in."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Behavioral and why-this-firm questions"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"STAR without sounding robotic; research the desk before you walk in. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// behavioral why firm — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Behavioral and why-this-firm questions"}</strong> Pick one concrete sub-problem
