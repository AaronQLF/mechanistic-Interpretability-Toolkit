...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="offers-negotiation"
      chapters={interviewChapters}
      eyebrow={"Interview Strategy & Mocks · 05"}
      title={"Offers & negotiation"}
      lede={"Comp, bonus structure, non-competes — high-level map without legal advice."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Offers & negotiation"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Comp, bonus structure, non-competes — high-level map without legal advice. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// offers negotiation — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Offers & negotiation"}</strong> Pick one concrete sub-problem
