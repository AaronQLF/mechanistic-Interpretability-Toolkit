...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="mock-cpp-systems"
      chapters={interviewChapters}
      eyebrow={"Interview Strategy & Mocks · 08"}
      title={"Mock set: C++ & systems"}
      lede={"Language, concurrency, and OS questions in one sitting."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Mock set: C++ & systems"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Language, concurrency, and OS questions in one sitting. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// mock cpp systems — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Mock set: C++ & systems"}</strong> Pick one concrete sub-problem
