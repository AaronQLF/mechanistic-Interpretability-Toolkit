...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="coding-structure"
      chapters={interviewChapters}
      eyebrow={"Interview Strategy & Mocks · 02"}
      title={"Structuring a coding answer"}
      lede={"Clarify, complexity, implement, test — live at the whiteboard without panicking."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Structuring a coding answer"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Clarify, complexity, implement, test — live at the whiteboard without panicking. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// coding structure — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Structuring a coding answer"}</strong> Pick one concrete sub-problem
