...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="brainteaser-communication"
      chapters={interviewChapters}
      eyebrow={"Interview Strategy & Mocks · 03"}
      title={"Thinking aloud through brainteasers"}
      lede={"Narrate assumptions, track algebra, recover from dead ends."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Thinking aloud through brainteasers"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Narrate assumptions, track algebra, recover from dead ends. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// brainteaser communication — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Thinking aloud through brainteasers"}</strong> Pick one concrete sub-problem
