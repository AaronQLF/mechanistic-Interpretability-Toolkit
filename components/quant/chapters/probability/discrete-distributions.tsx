...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="discrete-distributions"
      chapters={quantProbabilityChapters}
      eyebrow={"Probability for Interviews · 06"}
      title={"Discrete distributions"}
      lede={"Bernoulli, binomial, geometric, Poisson — which story matches which PMF."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Discrete distributions"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Bernoulli, binomial, geometric, Poisson — which story matches which PMF. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// discrete distributions — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Discrete distributions"}</strong> Pick one concrete sub-problem
