...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="counting-combinatorics"
      chapters={quantProbabilityChapters}
      eyebrow={"Probability for Interviews · 01"}
      title={"Counting & combinatorics"}
      lede={"Permutations, combinations, stars-and-bars — speed and no double counting."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Counting & combinatorics"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Permutations, combinations, stars-and-bars — speed and no double counting. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// counting combinatorics — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Counting & combinatorics"}</strong> Pick one concrete sub-problem
