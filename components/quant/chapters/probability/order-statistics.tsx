...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="order-statistics"
      chapters={quantProbabilityChapters}
      eyebrow={"Probability for Interviews · 08"}
      title={"Order statistics"}
      lede={"Max of exponentials, expected minimum — tournament and auction analogies."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Order statistics"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Max of exponentials, expected minimum — tournament and auction analogies. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// order statistics — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Order statistics"}</strong> Pick one concrete sub-problem
