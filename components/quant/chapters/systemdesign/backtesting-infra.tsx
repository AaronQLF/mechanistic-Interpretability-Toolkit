...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="backtesting-infra"
      chapters={systemdesignChapters}
      eyebrow={"Trading System Design · 09"}
      title={"Backtesting infrastructure"}
      lede={"Look-ahead bias, survivorship, execution simulation — trust nothing."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Backtesting infrastructure"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Look-ahead bias, survivorship, execution simulation — trust nothing. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// backtesting infra — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Backtesting infrastructure"}</strong> Pick one concrete sub-problem
