...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="distributed-basics"
      chapters={systemdesignChapters}
      eyebrow={"Trading System Design · 10"}
      title={"Distributed systems essentials"}
      lede={"CAP as intuition, consensus at a glance, and why HFT is often deliberately not distributed."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Distributed systems essentials"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"CAP as intuition, consensus at a glance, and why HFT is often deliberately not distributed. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// distributed basics — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Distributed systems essentials"}</strong> Pick one concrete sub-problem
