...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="design-framework"
      chapters={systemdesignChapters}
      eyebrow={"Trading System Design · 01"}
      title={"A framework for system design interviews"}
      lede={"Requirements, capacity, API, data model, and drawing boxes with arrows that mean something."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"A framework for system design interviews"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Requirements, capacity, API, data model, and drawing boxes with arrows that mean something. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// design framework — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"A framework for system design interviews"}</strong> Pick one concrete sub-problem
