...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 04"}
      title={"String algorithms"}
      lede={"KMP, Z-function, suffix structures — know the one you can derive under pressure."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"String algorithms"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"KMP, Z-function, suffix structures — know the one you can derive under pressure. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// strings — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"String algorithms"}</strong> Pick one concrete sub-problem
