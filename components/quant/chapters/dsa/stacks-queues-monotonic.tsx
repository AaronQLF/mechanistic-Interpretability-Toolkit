...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="stacks-queues-monotonic"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 06"}
      title={"Stacks, queues & monotonic structures"}
      lede={"Next greater element, histogram max rectangle — monotonic stack patterns."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Stacks, queues & monotonic structures"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Next greater element, histogram max rectangle — monotonic stack patterns. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// stacks queues monotonic — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Stacks, queues & monotonic structures"}</strong> Pick one concrete sub-problem
