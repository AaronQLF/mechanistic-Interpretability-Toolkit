...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="recursion-backtracking"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 13"}
      title={"Recursion & backtracking"}
      lede={"Generate subsets/permutations; pruning the search tree."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Recursion & backtracking"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Generate subsets/permutations; pruning the search tree. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// recursion backtracking — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Recursion & backtracking"}</strong> Pick one concrete sub-problem
