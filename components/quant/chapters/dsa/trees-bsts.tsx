...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="trees-bsts"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 07"}
      title={"Trees & binary search trees"}
      lede={"Traversals, height, balancing intuition — AVL/red-black at a high level."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Trees & binary search trees"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Traversals, height, balancing intuition — AVL/red-black at a high level. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// trees bsts — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Trees & binary search trees"}</strong> Pick one concrete sub-problem
