...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 05"}
      title={"Linked lists"}
      lede={"Reversal, cycles, merge — pointer manipulation without leaking memory."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Linked lists"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Reversal, cycles, merge — pointer manipulation without leaking memory. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// linked lists — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Linked lists"}</strong> Pick one concrete sub-problem
