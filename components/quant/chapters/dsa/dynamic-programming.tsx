...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 14"}
      title={"Dynamic programming"}
      lede={"Top-down vs bottom-up, state design, knapsack and LCS families."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Dynamic programming"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Top-down vs bottom-up, state design, knapsack and LCS families. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// dynamic programming — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Dynamic programming"}</strong> Pick one concrete sub-problem
