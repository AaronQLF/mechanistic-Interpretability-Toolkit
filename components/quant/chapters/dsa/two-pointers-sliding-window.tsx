...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="two-pointers-sliding-window"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 02"}
      title={"Two pointers & sliding window"}
      lede={"Linear scans on sorted arrays and fixed/variable-size windows — the bread and butter of coding rounds."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Two pointers & sliding window"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Linear scans on sorted arrays and fixed/variable-size windows — the bread and butter of coding rounds. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// two pointers sliding window — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Two pointers & sliding window"}</strong> Pick one concrete sub-problem
