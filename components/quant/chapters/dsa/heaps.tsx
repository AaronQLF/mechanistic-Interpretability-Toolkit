...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 09"}
      title={"Heaps & priority queues"}
      lede={"Median streaming, k-way merge, Dijkstra with a binary heap."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Heaps & priority queues"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Median streaming, k-way merge, Dijkstra with a binary heap. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// heaps — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Heaps & priority queues"}</strong> Pick one concrete sub-problem
