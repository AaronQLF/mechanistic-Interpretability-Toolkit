...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="graphs-bfs-dfs"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 10"}
      title={"Graphs: BFS & DFS"}
      lede={"Components, bipartite check, topological sort via DFS."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Graphs: BFS & DFS"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Components, bipartite check, topological sort via DFS. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// graphs bfs dfs — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Graphs: BFS & DFS"}</strong> Pick one concrete sub-problem
