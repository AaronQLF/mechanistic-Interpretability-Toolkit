...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="capstone-segment-fenwick"
      chapters={dsaChapters}
      eyebrow={"Data Structures & Algorithms · 17"}
      title={"Capstone: segment trees & Fenwick trees"}
      lede={"Range queries and point updates — build both from scratch on a whiteboard."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Capstone: segment trees & Fenwick trees"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Range queries and point updates — build both from scratch on a whiteboard. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// capstone segment fenwick — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Capstone: segment trees & Fenwick trees"}</strong> Pick one concrete sub-problem
