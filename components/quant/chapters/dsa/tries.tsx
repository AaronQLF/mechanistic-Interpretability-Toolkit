...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 08"}
      title={"Tries"}
      lede={"Prefix trees for autocomplete and bitwise tries for XOR max problems."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Tries"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Prefix trees for autocomplete and bitwise tries for XOR max problems. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// tries — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Tries"}</strong> Pick one concrete sub-problem
