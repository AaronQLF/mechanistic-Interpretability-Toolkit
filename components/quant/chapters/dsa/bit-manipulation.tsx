...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      eyebrow={"Data Structures & Algorithms · 16"}
      title={"Bit manipulation"}
      lede={"XOR tricks, subsets, popcount — micro-optimizations and puzzle patterns."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Bit manipulation"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"XOR tricks, subsets, popcount — micro-optimizations and puzzle patterns. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// bit manipulation — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Bit manipulation"}</strong> Pick one concrete sub-problem
