...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="time-value-rates-bonds"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 01"}
      title={"Time value, rates & bonds"}
      lede={"Discount factors, spot/forward rates, yield — the language of fixed income."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Time value, rates & bonds"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Discount factors, spot/forward rates, yield — the language of fixed income. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// time value rates bonds — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Time value, rates & bonds"}</strong> Pick one concrete sub-problem
