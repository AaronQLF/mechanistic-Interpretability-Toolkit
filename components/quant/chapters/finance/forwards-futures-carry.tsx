...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="forwards-futures-carry"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 03"}
      title={"Forwards, futures & carry"}
      lede={"Cost of carry, convenience yield, futures vs forward mark-to-market."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Forwards, futures & carry"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Cost of carry, convenience yield, futures vs forward mark-to-market. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// forwards futures carry — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Forwards, futures & carry"}</strong> Pick one concrete sub-problem
