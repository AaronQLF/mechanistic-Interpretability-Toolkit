...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="no-arbitrage-pricing"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 02"}
      title={"No-arbitrage pricing"}
      lede={"Law of one price, replicating portfolios, and absent arbitrage in discrete models."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"No-arbitrage pricing"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Law of one price, replicating portfolios, and absent arbitrage in discrete models. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// no arbitrage pricing — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"No-arbitrage pricing"}</strong> Pick one concrete sub-problem
