import { BinomialLattice } from "@/components/viz/quant/BinomialLattice";
...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="binomial-model"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 05"}
      title={"The binomial model"}
      lede={"One-step and multi-step trees, risk-neutral probabilities, early exercise preview."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"The binomial model"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"One-step and multi-step trees, risk-neutral probabilities, early exercise preview. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// binomial model — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"The binomial model"}</strong> Pick one concrete sub-problem
