...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="exotics-overview"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 10"}
      title={"Exotics overview"}
      lede={"Barriers, Asians, lookbacks — pricing hooks and hedging headaches."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Exotics overview"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Barriers, Asians, lookbacks — pricing hooks and hedging headaches. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// exotics overview — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Exotics overview"}</strong> Pick one concrete sub-problem
