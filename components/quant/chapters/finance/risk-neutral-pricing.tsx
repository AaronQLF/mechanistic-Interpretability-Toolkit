...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="risk-neutral-pricing"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 06"}
      title={"Risk-neutral valuation"}
      lede={"Change of measure intuition — why drift disappears in the discounted price."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Risk-neutral valuation"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Change of measure intuition — why drift disappears in the discounted price. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// risk neutral pricing — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Risk-neutral valuation"}</strong> Pick one concrete sub-problem
