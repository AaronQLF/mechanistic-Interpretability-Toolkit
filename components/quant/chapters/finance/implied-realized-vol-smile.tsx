...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="implied-realized-vol-smile"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 09"}
      title={"Implied vs realized vol & the smile"}
      lede={"IV surface, skew, and why Black–Scholes is wrong but useful."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Implied vs realized vol & the smile"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"IV surface, skew, and why Black–Scholes is wrong but useful. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// implied realized vol smile — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Implied vs realized vol & the smile"}</strong> Pick one concrete sub-problem
