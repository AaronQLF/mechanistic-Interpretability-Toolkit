...
export default function QuantChapter() {
  return (
    <ChapterShell
      ...
      chapterSlug="capstone-portfolio-capm"
      chapters={financeChapters}
      eyebrow={"Quantitative Finance & Options · 12"}
      title={"Capstone: portfolios, CAPM & Sharpe"}
      lede={"Mean–variance frontier, beta, and interview questions on risk-adjusted returns."}
    >
      <h2>What interviewers want here</h2>
      <p>
        You should be able to explain <strong>{"Capstone: portfolios, CAPM & Sharpe"}</strong> in plain language,
      ...
      <h2>Core ideas</h2>
      <p>{"Mean–variance frontier, beta, and interview questions on risk-adjusted returns. This chapter stays deliberately dense: skim once for the map, then work the challenge cold before you peek at the solution."}</p>
      ...
      <CodeBlock
        ...
        code={`// capstone portfolio capm — adapt types and invariants
#include <cstdint>
#include <vector>
...
`}
      ...
      <Challenge
        ...
        prompt={
          <>
            <p>
              <strong>Problem {"Capstone: portfolios, CAPM & Sharpe"}</strong> Pick one concrete sub-problem
